...
namespace Vesper.App.Tests.Utils {
    ...
    public void register_string_utils_tests () {
        Test.add_func("/vesper/utils/string_utils/format_time_short", test_format_time_short);
        Test.add_func("/vesper/utils/string_utils/format_time_long", test_format_time_long);
    }
}