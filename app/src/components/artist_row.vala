...
namespace PiPod.App.Components {
    public class ArtistRow : Button {
        ...
        public ArtistRow (Artist artist) {
        ...
        private void build_ui () {
            ...
            Image icon = new Image.from_icon_name ("system-users-symbolic");
            icon.pixel_size = 20;

            Label label = new Label (artist.name);
        ...
        private void connect_signals () {
            clicked.connect (() => selected (artist));
        }
    }
}